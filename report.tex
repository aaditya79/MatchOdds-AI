...
The YouTube result reflects statistical noise from a different game sample combined with the fact that YouTube returns zero signal for historical games.
...
For RQ3, the ablation study is still pending for six of seven sources. The final interpretation should be updated once all ablation runs complete.
